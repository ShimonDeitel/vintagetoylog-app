...
final class VintageToyLogUITests: XCTestCase {
    ...
    func testAddFlow() {
        ...
        nameField.tap()
        nameField.typeText("UI Test Toy")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["UI Test Toy"].waitForExistence(timeout: 2))
    }
